	package cn.dc.wechattest.util;


    import cn.dc.wechattest.bean.menu.Menu;
    ...
    public class MenuUtil {
        ...
        public static boolean createMenu(Menu menu, String accessToken) {
            ...
            String outputStr = "{\"button\":["
                    ...
                    + "]},"
                    + "{\"type\":\"view\",\"name\":\"我要点餐\",\"url\":\"https://cdata.tunnel.mobi/myweixin/mainServlet\"},"
                    + "{\"name\":\"我的服务\","
                    + "\"sub_button\":["
            ...
            if (null != jsonObject) {
                ...
                if (0 == errorCode) {
                    log.error("创建菜单成功errcode:{} errmsg:{}", errorCode, errorMsg);
                    result = true;
                } else {
                    result = false;
